 ...
 * @version 11/13/25
 */
public class JavaContainsValueTimingExperiment extends TimingExperiment {
    private Random random = new Random();
    private ArrayList<String> keys = new ArrayList<>();
    private ArrayList<Integer> values = new ArrayList<>();
    private TreeMap<String, Integer> table = new TreeMap<>();

    public JavaContainsValueTimingExperiment(String problemSizeName, List<Integer> problemSizes, int iterationCount) {
    ...
    public static void main(String[] args) {
        ...
        TimingExperiment experiment = new JavaContainsValueTimingExperiment("number_of_values_to_check", problemSizes, iterationCount);
