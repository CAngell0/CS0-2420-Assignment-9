...
/**
 * A timing experiment to test the speed fo the student object with good hash functions
...
public class StudentGoodHashTimingExperiment extends TimingExperiment {
    ...
    private ArrayList<StudentGoodHash> students = new ArrayList<>();
    private ArrayList<Integer> grades = new ArrayList<>();
    private HashTable<StudentGoodHash, Integer> studentGrades = new HashTable<>();
    ...
    public static void main(String[] args) {
        ...
        List<Integer> problemSizes = buildProblemSizes(100000, 1000, 2000);
    ...
    protected void setupExperiment(int problemSize) {
        ...
        studentGrades.clear();
        studentGrades = new HashTable<StudentGoodHash, Integer>();
