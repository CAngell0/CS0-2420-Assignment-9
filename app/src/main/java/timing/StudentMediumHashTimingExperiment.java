...
/**
 * A timing experiment to test the speed fo the student object with medium hash functions
...
public class StudentMediumHashTimingExperiment extends TimingExperiment {
    ...
    private ArrayList<StudentMediumHash> students = new ArrayList<>();
    private ArrayList<Integer> grades = new ArrayList<>();
    private HashTable<StudentMediumHash, Integer> studentGrades = new HashTable<>();
    ...
    protected void setupExperiment(int problemSize) {
        ...
        studentGrades.clear();
        studentGrades = new HashTable<StudentMediumHash, Integer>();
